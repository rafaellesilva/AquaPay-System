...
public class ConsumoAgua {
    ...
    public float leituraAnterior;
    public float leituraAtual;
    ...
    public double calculaPrecoConsumo(){
        ...
        double precoConsumoAgua = 0.0;
        double tarifaBasica = 10.0; // valor da tarifa básica de água e esgoto
        double taxaAdicional = 1.5; // valor da taxa adicional
        double imposto = 0.05; // valor do imposto
        ...
        if (categoria.equals("Categoria 1")) {
            precoConsumoAgua = consumoAgua * 0.5;
        } else if (categoria.equals("Categoria 2")) {
            precoConsumoAgua = 10 * 0.5 + (consumoAgua - 10) * 0.8;
        } else if (categoria.equals("Categoria 3")) {
            precoConsumoAgua = 10 * 0.5 + 10 * 0.8 + (consumoAgua - 20) * 1.2;
        } else if (categoria.equals("Categoria 4")) {
            precoConsumoAgua = 10 * 0.5 + 10 * 0.8 + 10 * 1.2 + (consumoAgua - 30) * 1.5;
        }
        ...
        double precoFinal = precoConsumoAgua + tarifaBasica + (precoConsumoAgua * taxaAdicional) + (precoConsumoAgua * imposto);
